...
import com.example.chapter1_kotlin.presenter.KotlinNaviPresenter
import com.example.chapter1_kotlin.presenter.lessonNavi.KotlinLessonNaviProxy
...
class KotlinActivity : BaseActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    mPresenter.apply{
      add(KotlinNaviPresenter(chapterBridge, binding))
    }
  ...
  override fun onHandleNavigation(entity: ChapterNaviEntities): Boolean {
    return if(entity is ChapterNaviEntities.Chapter1KotlinGuide)
      KotlinLessonNaviProxy.jumpTo(this, entity)
    else
      false
  }
}