...
import com.example.chapter2_core_and_view.lesson2room.Lesson2RoomActivity
...
object CoreAndViewNaviProxy {
  private fun getIntent(context: Context, chapter: Chapter2AndroidGuide): Intent? {
    return when(chapter){
      ...
      is Chapter2AndroidGuide.Lesson2Room -> Intent(context, Lesson2RoomActivity::class.java)
    }
  }
